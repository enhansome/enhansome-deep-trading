...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,486 | 🐛 106 | 📅 2026-09-02
...
© 2021 Craig Bailes ([@cbailes](https://github.com/cbailes) | [Patreon](https://www.patreon.com/craigbailes) | <contact@craigbailes.com>)
...
* [Yvictor/TradingGym](https://github.com/Yvictor/TradingGym) ⭐ 1,917 | 🐛 11 | 🌐 Python | 📅 2024-02-11 - Trading and Backtesting environment for training reinforcement learning agent or simple rule base algo
* [notadamking/RLTrader](https://github.com/notadamking/RLTrader) ⭐ 1,866 | 🐛 43 | 🌐 Python | 📅 2022-01-22 - A cryptocurrency trading environment using deep reinforcement learning and OpenAI's gym
...
* [gujiuxiang/Deep\_Trader.pytorch](https://github.com/gujiuxiang/Deep_Trader.pytorch) - This project uses Reinforcement learning on stock market and agent tries to learn trading. PyTorch based.

## Generative Adversarial Networks (GANs)

* [borisbanushev/stockpredictionai](https://github.com/borisbanushev/stockpredictionai) ⭐ 5,602 | 🐛 364 | 🌐 JavaScript | 📅 2025-08-19 - A notebook for stock price movement prediction using an LSTM generator and CNN discriminator
