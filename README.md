...
* [Yvictor/TradingGym](https://github.com/Yvictor/TradingGym) ⭐ 1,912 | 🐛 11 | 🌐 Python | 📅 2024-02-11 - Trading and Backtesting environment for training reinforcement learning agent or simple rule base algo
...
* [borisbanushev/stockpredictionai](https://github.com/borisbanushev/stockpredictionai) ⭐ 5,592 | 🐛 364 | 🌐 JavaScript | 📅 2025-08-19 - A notebook for stock price movement prediction using an LSTM generator and CNN discriminator
